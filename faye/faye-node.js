...
Faye.WebSocket.Protocol8Parser = Faye.Class({
  ...
  OPCODES: {"ping":9,"text":1,"continuation":0,"binary":2,"pong":10,"close":8},
  FRAGMENTED_OPCODES: [0,1,2],
  OPENING_OPCODES: [1,2],
  
  ERRORS: {"too_large":1009,"going_away":1001,"extension_error":1010,"protocol_error":1002,"unacceptable":1003,"encoding_error":1007,"policy_violation":1008,"normal_closure":1000},
  
  ERROR_CODES: [1009,1001,1010,1002,1003,1007,1008,1000],
  ...
  request: function(message, timeout) {
    ...
    var request = client.request({
      ...
      headers:  {
        ...
        /* #soe - add access_token to header */
        'Authorization':  'OAuth '+ message[0].access_token || 'None',
